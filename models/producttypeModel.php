...
class producttype extends DBManagerModel{
    ...
    public function getList($params = array()){
        ...
        $query = "SELECT `producttypeId`, description, date_entered, `display_name` AS `created_by`, created_by AS `created`
    ...
    public function edit(){
        $this->updateRecord($this->entity(), $_POST, array("producttypeId" => $_POST["producttypeId"]));
    }
    public function del(){
        $this->delRecord($this->entity(), array("producttypeId" => $_POST["id"]));
    }

    public function entity()
    {
        $data = array(
                        "tableName" => $this->pluginPrefix."producttype"
                        ,"columnValidateEdit" => "created"
                        ,"entityConfig" => array("add" => true, "edit" => true, "del" => true, "view" => false)
                        ,"atributes" => array(
                                "producttypeId" => array("type" => "int", "PK" => 0, "required" => false,"edithidden"=>true, "readOnly" => true, "autoIncrement" => true )                            
